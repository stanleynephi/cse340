--creating and enum type for account type
CREATE TYPE public.account_type AS ENUM
    ('Client', 'Employee', 'Admin');

ALTER TYPE public.account_type
    OWNER TO cse340nephi;
...
--creating a relationship between classification and inventory.
...
VALUES   (
  ...
  --adding tony start to the accout table.
  insert into public.account(account_firstname,account_lastname,account_email,account_password)
	values(
		'Tony','Stark','tony@starkent.com','Iam1ronM@n'
	)

  --modifyiing the tony start account in the account table to be an admin
update account
set account_type = 'Admin'
where account_id = 1

--delete the tony stark information from the database
delete from account 
where account_id = 1;

--update the GM hummer from small interior to huge interior
update inventory
set
...
--update to add /vehicles to the images path extension
update inventory
set 
